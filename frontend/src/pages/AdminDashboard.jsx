...
//           <div>
//             <h1 className="text-4xl font-bold">DevOps Admin Dashboard</h1>

//             <p className="text-zinc-400 mt-2">
//               Manage Projects, Messages and Portfolio.
//             </p>
//           </div>

//           <button
//             onClick={handleLogout}
//             className="flex items-center gap-2 bg-red-500 hover:bg-red-600 px-5 py-3 rounded-xl font-semibold transition"
//           >
//             <LogOut size={18} />
//             Logout
//           </button>
...
//           <StatCard title="Messages" value={messages.length} icon={Mail} />
//         </div>
...
//               className="flex items-center gap-2 bg-teal-500 hover:bg-teal-600 px-5 py-3 rounded-xl font-medium transition"
//             >
//               <Plus size={18} />
//               Add Project
//             </button>
...
//               className="w-full bg-zinc-950 border border-zinc-700 rounded-xl pl-11 pr-4 py-3 outline-none focus:border-teal-500"
//             />
//           </div>
...
//         <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6 mb-8">
//           <h2 className="text-2xl font-semibold mb-5">Recent Messages</h2>
