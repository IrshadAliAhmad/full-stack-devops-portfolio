...
//     <section
//       id="contact"
//       // Tightened up section margins to draw layouts closer to neighbors smoothly
//       className="relative py-10 lg:py-16 bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-[#0d0e12] dark:via-[#090a0f] dark:to-[#0c0e17] text-zinc-900 dark:text-zinc-50 transition-colors duration-500 overflow-hidden"
//     >
//       {/* Visual neon radial backdrop spots */}
//       <div className="absolute top-1/4 left-1/4 w-[450px] h-[450px] bg-gradient-to-tr from-blue-500/10 to-purple-500/5 dark:from-blue-600/5 dark:to-transparent blur-[120px] rounded-full pointer-events-none animate-pulse duration-[8000ms]" />
//       <div className="absolute bottom-1/4 right-1/4 w-[450px] h-[450px] bg-gradient-to-br from-pink-500/10 to-purple-500/5 dark:from-purple-600/5 dark:to-transparent blur-[120px] rounded-full pointer-events-none animate-pulse duration-[6000ms]" />
...
//             Get In Touch
//           </span>
//           <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mt-3 tracking-tight text-zinc-950 dark:text-white">
...
//         {/* Dynamic Card Container with Hover Multi-Color Edge Glow */}
//         <motion.div
//           initial={{ opacity: 0, y: 30 }}
//           whileInView={{ opacity: 1, y: 0 }}
//           viewport={{ once: true }}
//           transition={{ duration: 0.8, delay: 0.1 }}
//           className="relative group p-[1px] rounded-3xl bg-gradient-to-b from-slate-200 to-slate-300 dark:from-zinc-800 dark:to-zinc-800/50 shadow-xl hover:shadow-[0_20px_50px_rgba(99,102,241,0.15)] dark:hover:from-blue-500 dark:hover:via-purple-500 dark:hover:to-pink-500 transition-all duration-500"
//         >
//           {/* Radial layout neon lighting aura that highlights on focus hover */}
//           <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 opacity-0 group-hover:opacity-10 blur-3xl transition-opacity duration-500 pointer-events-none" />

//           {/* Core interface content inner wrap holding input boxes */}
//           <div className="relative bg-white/80 dark:bg-zinc-900/40 backdrop-blur-md rounded-[23px] p-6 sm:p-10 md:p-12">
...
//                     <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-zinc-400 group-focus-within/input:text-blue-500 transition-colors duration-200">
...
//                       className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-slate-50/50 dark:bg-zinc-950/20 border border-slate-200 dark:border-zinc-800/60 outline-none text-sm font-medium transition-all duration-300 focus:border-blue-500 dark:focus:border-blue-500 focus:bg-white dark:focus:bg-zinc-900/60 focus:ring-4 focus:ring-blue-500/10 shadow-inner text-zinc-900 dark:text-white"
//                       required
//                     />
//                   </div>
//                 </motion.div>
...
//                   </label>
//                   <div className="relative group/input">
//                     <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-zinc-400 group-focus-within/input:text-purple-500 transition-colors duration-200">
...
//                       className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-slate-50/50 dark:bg-zinc-950/20 border border-slate-200 dark:border-zinc-800/60 outline-none text-sm font-medium transition-all duration-300 focus:border-purple-500 dark:focus:border-purple-500 focus:bg-white dark:focus:bg-zinc-900/60 focus:ring-4 focus:ring-purple-500/10 shadow-inner text-zinc-900 dark:text-white"
//                       required
//                     />
//                   </div>
//                 </motion.div>
...
//                     className="w-full px-4 py-3.5 rounded-xl bg-slate-50/50 dark:bg-zinc-950/20 border border-slate-200 dark:border-zinc-800/60 outline-none text-sm font-medium transition-all duration-300 focus:border-purple-500 dark:focus:border-purple-500 focus:bg-white dark:focus:bg-zinc-900/60 focus:ring-4 focus:ring-purple-500/10 shadow-inner text-zinc-900 dark:text-white"
//                     required
//                   />
//                 </motion.div>
//               </div>
...
//                   onChange={handleChange}
//                   placeholder="Tell me about your infrastructure goals, system needs, or project timeline..."
//                   rows="5"
//                   minLength="20"
//                   className="w-full p-4 rounded-xl bg-slate-50/50 dark:bg-zinc-950/20 border border-slate-200 dark:border-zinc-800/60 outline-none text-sm font-medium transition-all duration-300 focus:border-pink-500 dark:focus:border-pink-500 focus:bg-white dark:focus:bg-zinc-900/60 focus:ring-4 focus:ring-pink-500/10 shadow-inner resize-none text-zinc-900 dark:text-white"
//                   required
//                 />
//               </motion.div>
...
//                   }}
//                   whileTap={{ scale: 0.98 }}
//                   className="w-full sm:w-auto sm:px-16 flex items-center justify-center gap-3 relative overflow-hidden bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white font-bold py-4 rounded-xl shadow-lg transition-all duration-300 text-sm tracking-wide disabled:opacity-75 disabled:cursor-not-allowed group/btn hover:brightness-110"
//                 >
//                   {loading ? (
//                     <>
...
//                   ) : (
//                     <>
//                       <FaPaperPlane className="text-xs transition-transform duration-300 group-hover/btn:translate-x-1 group-hover/btn:-translate-y-0.5" />
...
//                     className={`flex items-center justify-center gap-2 p-3.5 mt-4 rounded-xl border text-xs font-bold tracking-wide ${
//                       status.type === "success"
