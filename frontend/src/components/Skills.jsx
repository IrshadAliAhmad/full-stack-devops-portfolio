...
//       if (width >= 1024) {
//         // Desktop devices: dynamic scale calculation based on exact width
...
//       } else if (width >= 768) {
//         // Tablet devices: dynamic scale calculation based on exact width
...
//       } else {
//         // Mobile devices: dynamic calculations to completely fix crowding/overlapping issues
//         const dynamicRadius = Math.min(190, Math.max(135, width * 0.42));
//         setRadius(dynamicRadius); 
//         setIsMobile(true);
//         // Trim elements slightly on phone viewport to eliminate congestion layout issues
...
//   // Frame processing rendering cycle loop for 3D spin effects
//   useEffect(() => {
//     let animationId;
//     const updateFrame = () => {
...
//         circleRef.current.style.setProperty("--total-rotation", `${currentRotation.current}deg`);
//         const cards = circleRef.current.querySelectorAll('.inner-content');
//         cards.forEach((card, index) => {
//           const rotateY = (360 / skills.length) * index;
//           // Keeps text elements facing directly front toward the viewport camera
...
//   // Desktop Mouse move tracking to change spin direction dynamically
...
//   // Mobile touch interaction event overrides
...
//     <section 
//       id="skills" 
//       // Reduced top/bottom padding to keep the section compact and close to adjacent layouts
...
//         {/* 3D Carousel Perspective Render Stage */}
//         <div 
...
//                 >
//                   {/* Inside card element mapping layouts */}
